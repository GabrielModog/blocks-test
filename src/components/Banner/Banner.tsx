  ...
  return (
    <>
      {isShowing && (
        <div
          role="banner"
          className="flex flex-col md:flex-row items-center justify-center bg-zinc-900 text-white py-4 md:h-[67px] lg:h-full"
        >
          <CloseButton handleToggle={handleToggle} />
          <p className="p-1 text-center text-xl md:text-sm md:mr-4">
